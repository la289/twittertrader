...
def test_get_sentiment_1(analysis):
    assert analysis.get_sentiment(get_tweet_text("1354862801320349704")) > 0
...
## TODO: Make this work on some companies that shardi tweets about

# def test_find_companies_1(analysis):
#     assert analysis.find_companies(get_tweet("1356318418639736834")) == [{
#         "exchange": "New York Stock Exchange",
#         "name": "Boeing",
#         "sentiment": -0.5,
#         "ticker": "BA"}, {
